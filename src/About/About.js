  ...
  return (
    <div>
      ...
      <p className="Paragraf">
        UberBus is our new feature which is intended to give assutance of safty
        to use who prefer to ride with others.</p>
      ...
      <p className="Paragraf">
        Open the app and enter where you´re going in the Where to?box. Amap will
        comeup showing the nearby routes.
      </p>
      <p className="Paragraf">
      ...
      <p className="Paragraf">
        Let us know how your trip went. You can rate your fellow riders and also
        give your driver a compliment or add a tip in the app.
      </p>
